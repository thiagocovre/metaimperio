...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getCustomerOfSeller()
    {
        ...
        $seller =  $objectManager->get('Lof\MarketPlace\Model\ResourceModel\Seller\Collection');
        $customer_id = [];
    ...
    {
        $collection = $this->customer->create()->getCollection()->addFieldToFilter('email', $customer_email)->getFirstItem();
        return $collection;
    }
    /**
    ...
    {
        $objectManager       = \Magento\Framework\App\ObjectManager::getInstance();
        $sellerOrder = $objectManager->create('Lof\MarketPlace\Model\Order')->getCollection()
    ...
    public function checkAuth($flag = true)
    {
        ...
        if (isset($header['Authorization'])) {
            ...
            if ($server_output && $flag) {
                $sellerFactory = $this->_objectManager->create("Lof\MarketPlace\Model\SellerFactory");
