    ...
    public function execute()
    {
        ...
        if ($id) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('The seller has been cancel verification.'));
        ...
        // display error message
        $this->messageManager->addError(__('We can\'t find a seller to cancel verification.'));
        // go to grid
        return $resultRedirect->setPath('*/*/');
    }
