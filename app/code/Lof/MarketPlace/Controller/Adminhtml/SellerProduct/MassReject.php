...
class MassReject extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $item) {
           ...
           $product->setApproval(3)->setStatus(\Magento\Catalog\Model\Product\Attribute\Source\Status::STATUS_DISABLED)->setStoreId(\Magento\Store\Model\Store::DEFAULT_STORE_ID);
