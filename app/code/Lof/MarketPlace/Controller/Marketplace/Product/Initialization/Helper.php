...
//        ?DateTimeFilter $dateTimeFilter = null
        ...
        $this->customOptionFactory = $customOptionFactory ?: $objectManager->get(\Magento\Catalog\Api\Data\ProductCustomOptionInterfaceFactory::class);
        $this->productLinkFactory = $productLinkFactory ?: $objectManager->get(\Magento\Catalog\Api\Data\ProductLinkInterfaceFactory::class);
        $this->productRepository = $productRepository ?: $objectManager->get(\Magento\Catalog\Api\ProductRepositoryInterface::class);
        $this->linkTypeProvider = $linkTypeProvider ?: $objectManager->get(\Magento\Catalog\Model\Product\LinkTypeProvider::class);
