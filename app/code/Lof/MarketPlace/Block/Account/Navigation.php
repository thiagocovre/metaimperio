...
class Navigation extends \Magento\Framework\View\Element\Html\Link\Current
{
    ...
    */
    ...
    public function getDetailAdminUnRead() {
        return $this->detail->getCollection()->addFieldToFilter('is_read',0)->addFieldToFilter('seller_send',0)->addFieldToFilter('message_admin',1);

    }
    public function getMessageUnRead() {
         $data = $this->message->getCollection()->addFieldToFilter('sender_id',$this->session->getCustomerId())->addFieldToFilter('is_read',0);
