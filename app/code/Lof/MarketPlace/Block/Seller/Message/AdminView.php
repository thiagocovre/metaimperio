...
class AdminView extends \Magento\Framework\View\Element\Template
{
    ...
    */
    ...
    public function getMessage() {
    	$message = $this->message->load($this->getMessageId());
    	return $message;
    }
    ...
    public function getDetail() {
        $detail = $this->detail->getCollection()->addFieldToFilter('message_id',$this->getMessageId())->addFieldToFilter('message_admin',1)->setOrder('detail_id','desc');
        return $detail;
    }
