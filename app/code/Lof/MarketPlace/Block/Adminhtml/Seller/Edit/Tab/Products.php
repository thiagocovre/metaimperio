...
class Products extends Extended
{
    ...
    {
        $collection = $this->_linkFactory->create()->useRelatedLinks()->getProductCollection()->addAttributeToSelect('*')->addAttributeToFilter('seller_id',array('in' => array(0,$this->getSeller()->getId())));
