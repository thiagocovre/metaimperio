        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['seller_id'])) {
                    ...
                    $item[$name]['verify'] = [
                        'href' => $this->urlBuilder->getUrl(self::SELLER_URL_PATH_VERIFY, ['seller_id' => $item['seller_id']]),
                        'label' => __('Verify'),
                        'confirm' => [
                    ...
                    $item[$name]['unverify'] = [
                        'href' => $this->urlBuilder->getUrl(self::SELLER_URL_PATH_UNVERIFY, ['seller_id' => $item['seller_id']]),
