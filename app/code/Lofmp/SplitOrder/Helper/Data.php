...
/**
 * A Magento 2 module named Lofmp/SplitOrder
 * Copyright (C) 2018 Lofmp
 *
 * This file included in Lofmp/SplitOrder is licensed under OSL 3.0
 *
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getAttributes($storeId = null)
    {
       ...
       /* return $this->scopeConfig->getValue(
            'lofmp_split_order/options/attributes',
            ScopeInterface::SCOPE_STORE,
            $storeId
        );*/
    }
