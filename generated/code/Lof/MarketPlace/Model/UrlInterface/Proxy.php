<?php
namespace Lof\MarketPlace\Model\UrlInterface;

/**
 * Proxy class for @see \Lof\MarketPlace\Model\UrlInterface
 */
class Proxy implements \Lof\MarketPlace\Model\UrlInterface, \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Lof\\MarketPlace\\Model\\UrlInterface', $shared = true)
    {
